...
#CPPFLAGS = -Wall -O3 -DDEBUGGING=0x33 -DCPU_DEBUG=0 -DTERMINAL_SPEED=$(TERMINAL_SPEED) -DSIMPLE_TIMER_MICROS
...
CPPFLAGS += -DDVI_BIT_DEPTH=1 -DDVI_RESOLUTION=DVI_RES_640x480p60 -DUSE_HOST_KBD
